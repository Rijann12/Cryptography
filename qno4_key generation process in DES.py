def permute_bits(bits, permutation):
    return [bits[i-1] for i in permutation]  # Adjusting for 0-based indexing
...
# Adjust the input key to be 64 bits by adding parity bits.
key = [int(b) for b in '0100101010101010101010110101010101001010101010101010110100000000']
